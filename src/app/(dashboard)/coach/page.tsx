...
export default function CoachPage() {
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
          ...
          <div className="max-w-2xl mx-auto space-y-4 pb-4 pt-6 px-8">
            ...
            {isLoading && (
              <div className="flex justify-start">
                ...
                >
                  <span className="ai-thinking inline-block" style={{ color: 'var(--text-muted)' }}>
                    Thinking...
                  </span>
                </div>
              </div>
      ...
      <div
        className={`fixed bottom-0 ${collapsed ? 'left-20' : 'left-64'} right-0 pt-8 pb-4 bg-gradient-to-t from-[#0F1729] via-[#0F1729] to-transparent transition-all duration-300`}
      >
